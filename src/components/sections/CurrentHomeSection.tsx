 ...
 * Primary fields cover value, mortgage, rate, loan position, and expected rent.
 * Advanced fields cover property taxes, insurance, maintenance, vacancy,
 * management fees, appreciation, and tenant turnover assumptions.
 */
