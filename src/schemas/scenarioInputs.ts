...
export const formDefaultValues = {
  personal: {
    age: DEFAULT_PERSONAL_INPUTS.age,
    ...
    monthlyDebtPayments: undefined as unknown as number,
    liquidSavings: undefined as unknown as number,
  },
  retirement: {
    iraBalance: DEFAULT_RETIREMENT_INPUTS.iraBalance,
    iraType: DEFAULT_RETIREMENT_INPUTS.iraType,
    ...
    iraWithdrawalAmountScenarioB: DEFAULT_RETIREMENT_INPUTS.iraWithdrawalAmountScenarioB,
  ...
  currentHome: {
    ...
    originalLoanTermYears: DEFAULT_CURRENT_HOME_INPUTS.originalLoanTermYears,
    yearsIntoLoan: DEFAULT_CURRENT_HOME_INPUTS.yearsIntoLoan,
    annualPropertyTaxRate: DEFAULT_CURRENT_HOME_INPUTS.annualPropertyTaxRate,
    annualInsurance: DEFAULT_CURRENT_HOME_INPUTS.annualInsurance,
  ...
  newHome: {
    ...
    annualPropertyTaxRate: DEFAULT_NEW_HOME_INPUTS.annualPropertyTaxRate,
    annualInsurance: DEFAULT_NEW_HOME_INPUTS.annualInsurance,
